...
/*! \file  example_02.cpp
    \brief Shows how to solve the parametrized filtered Darcy porosity optimization problem.
*/
...
int main(int argc, char *argv[]) {
  ...
  try {
    ...
    // Uncertain parameter convention:
    // param[0] = inlet flow-rate multiplier, param[1] = permeability multiplier.
    std::vector<RealT> uncertainParam = {static_cast<RealT>(1), static_cast<RealT>(1)};
    fobj->setParameter(uncertainParam);
