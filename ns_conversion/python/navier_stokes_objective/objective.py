...
class NavierStokesReducedObjective:
    ...
    def __init__(
        ...
        *,
        ...
        cubature_degree: int | None = None,
        newton_absolute_tol: float = 1e-12,
        newton_relative_tol: float = 0.0,
        newton_step_tol: float = 0.0,
        ...
        self.pin_pressure = bool(pin_pressure)
        self.linear_solver = linear_solver
        self.klu2_executable = klu2_executable
        ...
        if self.backend == "graph":
            ...
            degree = config.cubature_degree if cubature_degree is None else int(cubature_degree)
    ...
    def _build_fe_backend(self, fe_cell_ids: Any | None, cubature_degree: int) -> None:
        ...
        self.fe_constraint = DynamicNavierStokesFEConstraint.from_config(
            self.fe_assembler,
            self.config,
            pin_pressure=self.pin_pressure,
            linear_solver=self.linear_solver,
            klu2_executable=None if self.klu2_executable is None else str(self.klu2_executable),
        )
